...
jQuery(function($) {
  ...
  function legendary_toolkit_setImageFromURL(url, attachmentId, width, height) {
      var choice, data = {};
      ...
      */       
      ...
      mediaUploader.on('cropped', function(croppedImage) {
          ...
          var url = croppedImage.url,
              ...
              legendary_toolkit_setImageFromURL(url, attachmentId, w, h);            
      ...
      mediaUploader.on('skippedcrop', function(selection) {
          ...
          var url = selection.get('url'),
              ...
              legendary_toolkit_setImageFromURL(url, selection.id, w, h);            
      ...
      mediaUploader.on("select", function() {
          ...
          if (     cropControl.params.width  === attachment.width 
              ...
              && ! cropControl.params.flex_height ) {
                  legendary_toolkit_setImageFromAttachment( attachment );
              mediaUploader.close();
          } else {
